...
class Page2ViewController: UITableViewController, SegementSlideContentScrollViewDelegate {
    ...
    // 参考；https://qiita.com/satoshin2071/items/880ebdfe84dc6a6c8fbf
    ...
    func getYoutubeData() {
        // Get Request
        let requestUrl = "https://www.googleapis.com/youtube/v3/search?key=\(keys.youtubeAPIKey)&q=React×TypeScript&part=snippet&maxResults=40&order=date"
